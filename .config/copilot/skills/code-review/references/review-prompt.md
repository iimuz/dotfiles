...
- `<model-name>` is your model identifier (e.g., claude-sonnet-4.6-thinking-high, gemini-3-pro-preview, gpt-5.3-codex)

Example: `<session-folder>/files/security-claude-sonnet-4.6-thinking-high-review.md`
