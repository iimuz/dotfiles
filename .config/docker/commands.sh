...
alias dpoetry-all="_docker_run_mount_specific_dir_with_passwd .git --gpus all iimuz/python:v3.7.5-all3 poetry"
alias dpoetry-all-cuda="_docker_run_mount_specific_dir_with_passwd .git --gpus all iimuz/python:v3.7.5-all3 poetry"
...
alias dcpoetry-all="_docker_run_mount_specific_dir_with_passwd_command .git --gpus all iimuz/python:v3.7.5-all3 poetry"
